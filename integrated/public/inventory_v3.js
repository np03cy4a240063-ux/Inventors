        ...
        body.innerHTML = `
            <div style="display:flex; flex-direction:column; gap:20px;">
                <div style="position:relative;">
                    ${p.image_url 
                        ? `<img src="${p.image_url}" style="width:100%; height:300px; object-fit:cover; border-radius:16px; border:1px solid #E2E8F0; box-shadow:0 10px 25px -5px rgba(0,0,0,0.1);">` 
                        : `<div style="width:100%; height:200px; background:#F8FAFC; border-radius:16px; display:flex; align-items:center; justify-content:center; border:2px dashed #E2E8F0;"><i class="fas fa-box" style="font-size:3rem; color:#CBD5E1;"></i></div>`}
